...
slider_configs = {
    ...
    'catalyst_start_day': {'label': 'Catalyst Start Day', 'min': 0, 'max': default_settings['start_max'], 'step': 10.0, 'value': default_settings.get('start_default', min(default_settings['start_max'], 5))},
    ...
    'max_time': {'label': 'Max Time (days)', 'min': 100, 'max': default_settings['max_extend'], 'step': 100.0, 'value': default_settings['time_default']},
...
app.layout = dbc.Container([
    html.H1("Cu Recovery Prediction (Leach Days) - Interactive Dashboard", className='text-center my-4'),
