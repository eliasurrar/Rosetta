...
HEADER_LOGO_ASSET = "rosetta_logo_v2_large.png"
APPLE_TOUCH_ICON_ASSET = "rosetta_logo_v2_215x215.png"
...
def make_prediction_figure(pred: Dict[str, Any], max_day: float) -> go.Figure:
    ...
    fig.update_layout(
        ...
        title="Interactive Ensemble Prediction (v7)",
        height=760,
...
def build_geometry_guardrail_summary(
    ...
    return html.Div(
        html.Div(
            ...
            style={
                "fontSize": "12px",
                "color": "#b42318" if (not ratio_ok or not density_ok) else "#55606d",
                "lineHeight": "1.5",
            },
        ),
        style={
...
def create_app(project_root: str) -> Dash:
    ...
    favicon_href = inline_asset_data_url("favicon.ico", "image/x-icon")
    apple_touch_icon_href = inline_asset_data_url(APPLE_TOUCH_ICON_ASSET, "image/png")
    header_logo_src = inline_asset_data_url(HEADER_LOGO_ASSET, "image/png") or app.get_asset_url(HEADER_LOGO_ASSET)
    ...
    if apple_touch_icon_href:
        apple_touch_icon_tag = (
            f'\n            <link rel="apple-touch-icon" sizes="215x215" href="{apple_touch_icon_href}">'
        )
    app.index_string = f"""
    <!DOCTYPE html>
    <html>
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        [
                            html.H1(
                                "Rosetta NeuralNetwork Bi-Exponential Equation - Interactive Plot",
                                style={"margin": "0"},
                            ),
                        ],
                        style={"minWidth": "0"},
    ...
    app.clientside_callback(
        ...
        function(nClicks, figure, exportOptions) {
            ...
            const baseFilename = (exportOptions && exportOptions.filename) || meta.png_export_filename || "interactive_ensemble_prediction_v7_300dpi";
