...
CONFIG = {
    ...
    "max_catalyst_aging_strength": 10.0, # initially 5.0
...
MODEL_LOGIC_VERSION = "v10_continuous_single_uplift_20260407_horizontal_shift_gap_onset_fit"
...
LATENT_INTERACTION_SPECS: Dict[str, Dict[str, float]] = {
    ...
    "kappa": {
        # Geometry / transport accessibility
        "column_height_m_raw": 0.22,
        "material_size_p80_in": 0.30,
        "apparent_bulk_density_t_m3": 0.12,
        "material_size_to_column_diameter_ratio": 0.18,

        # Direct chemistry burden / receptivity
        "fe:cu": 0.16,
        "cu:fe": -0.08,
        "grouped_acid_generating_sulfides": 0.14,
        "grouped_fe_oxides": 0.08,
        ...
        # Learned chemistry / catalyst coupling terms
        "chem_interaction": 0.18,
        "ferric_synergy": 0.18,
    ...
    "aging_strength": {
        # Geometry / transport: deeper and tighter systems should age catalyst harder
        "column_height_m": 0.65,
        "column_height_m_raw": 0.65,
        "column_inner_diameter_m_raw": -0.10,
        "material_size_to_column_diameter_ratio": 0.22,
        "apparent_bulk_density_t_m3": 0.18,
        "material_size_p80_in": 0.10,

        # Core chemistry / oxidative burden
        "ferric_synergy": 0.28,
        "chem_interaction": 0.22,
        "primary_passivation_drive": 0.20,
        "passivation_strength": 0.14,
        "ore_decay_strength": 0.16,

        # Catalyst relevance
        "primary_catalyst_synergy": 0.26,
        "depassivation_strength": 0.18,
        "surface_refresh": 0.10,

        # Transport burden / residence-time proxies
        "diffusion_drag_strength": 0.24,

        # Acid buffering / easier systems reduce catalyst-aging pressure
        "acid_buffer_strength": -0.18,
        "grouped_carbonates": -0.10,
        "grouped_gangue_silicates": -0.06,

        # Systems dominated by fast or oxide recovery should need less catalyst tail
        "fast_leach_inventory": -0.16,
        "oxide_inventory": -0.10,
    },
}
